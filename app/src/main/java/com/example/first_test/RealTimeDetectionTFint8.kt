...
import com.example.first_test.ml.Yolov5sInt8
...
class RealTimeDetectionTFint8 : ComponentActivity(), SensorEventListener {
        ...
        try {
            ...
            try {
                val builder = Model.Options.Builder()
                    .setDevice(Model.Device.GPU) //GPU
                    .setNumThreads(4)
                    .build()

                module = Yolov5sInt8.newInstance(this, builder)
...
// @=============== END MAIN UI ===============@
    ...
    fun detectObjectsAndPaint(bitmap: Bitmap) : Bitmap? {
        ...
        val imgScaleX = bitmap.width
        val imgScaleY = bitmap.height
    ...
    private fun outputsToNMSPredictions(outputs: FloatArray, imgScaleX: Int, imgScaleY: Int): List<Result> {
